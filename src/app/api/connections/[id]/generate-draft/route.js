...
/**
 * POST /api/connections/[id]/generate-draft
 * Member generates AI draft message for their own connection
 */
export async function POST(request, { params }) {
    try {
        ...
        // Check if draft already exists - allow regeneration if not locked
